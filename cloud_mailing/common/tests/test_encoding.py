...
class TestEncodingUtils(unittest.TestCase):
    ...
    def test_force_text(self):
        ...
        self.assertEqual(force_text(Test()), '\u0160\u0110\u0106\u017d\u0107\u017e\u0161\u0111')
        self.assertEqual(force_text(TestU()), '\u0160\u0110\u0106\u017d\u0107\u017e\u0161\u0111')
        self.assertEqual(force_text(1), '1')
...
class TestRFC3987IEncodingUtils(unittest.TestCase):
    ...
    def test_iri_to_uri(self):
        cases = [
            ...
            ('locations/%s' % quote_plus(force_str('Paris & Orléans')), 'locations/Paris+%26+Orl%C3%A9ans'),
